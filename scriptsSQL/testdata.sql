...
/*==============================================================*/
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (24, 'Simu BV', 1, 41.734873737083021, -8.1594568490982056, 63, 11)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (25, 'Simu BM', 1, 41.719303769083453, -8.1724709272384644, 63, 11)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (26, 'Simu BV', 1, 41.734873737083021, -8.1594568490982056, 63, 11)

insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (1,'B.V. Amares', 1 ,41.626671, -8.370177, 50 ,14)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (2,'B.V. Barcelos', 1 ,41.532925, -8.614719, 72 ,15)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (3,'C.B.S. Braga', 1 ,41.553461, -8.429216, 85 ,12)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (4,'B.V. Braga', 1, 41.547574, -8.428412, 120 ,18)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (5,'B.V. Cabeceiras de Basto', 1, 41.514083, -7.990121, 58 ,13)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (6,'B.V. Esposende', 1, 41.533558, -8.778852, 65 ,20)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (7,'B.V. Fafe', 1 ,41.447822, -8.17529, 63 ,18)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (8,'B.V. Guimarães', 1 ,41.44669926365472, -8.29843282699585, 103 ,31)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (9,'B.V. Póvoa de Lanhoso', 1 ,41.577395, -8.27284, 83 ,21)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (10,'B.V. Vieira do Minho', 1 ,41.631322, -8.143294, 54,15)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (11,'B.V. Famalicão', 1 ,41.400993, -8.518058, 74 ,18)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (12,'B.V. Vila Verde', 1 ,41.651549, -8.438548, 49 ,17)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (13,'B.V. Vizela', 1 ,41.376032, -8.311937, 55 ,14)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (14,'B.V. Arcos de Valdevez', 1, 41.84688,-8.4199595, 58 ,15)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (15,'B.V. Caminha', 1, 41.874701, -8.840004, 65 ,17)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (16,'B.V. Melgaço', 1 ,42.111699, -8.257202, 49 ,16)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (17,'B.V. Monção', 1 ,42.073045, -8.484106, 53 ,18)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (18,'B.V. Paredes de Coura', 1, 41.911563, -8.558834, 48 ,14)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (19,'B.V. Ponte de Lima', 1 ,41.766919, -8.580735, 52 ,17)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (20,'B.V. Valença', 1 ,42.025972, -8.647937, 57 ,15)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (21,'B.V. Viana do Castelo', 1 ,41.694974, -8.829839, 65 ,20)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (22,'B.M. Viana do Castelo', 1 ,41.705177, -8.813336, 89 ,13)
insert into CORPORACAO (COD_CORPORACAO, CORPORACAO_DESIGN, DISPONIBILIDADE_CORP, LATITUDE_CORP, LONGITUDE_CORP, NUM_HOMENS_DISP, NUM_VEICULOS_DISP) values (23,'B.V. Vila Nova de Cerveira', 1, 41.939883, -8.743089, 63 ,11)


/*==============================================================*/
/* Test data for the table "Heli".                     */
/*==============================================================*/
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (1, 'Heli Resgate 01', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (2, 'Heli Resgate 02', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (3, 'Heli Resgate 03', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (4, 'Heli Combate 01', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (5, 'Heli Combate 02', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (6, 'Heli Combate 03', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (7, 'Heli Suporte 01', 1)
insert into HELI (COD_HELI, HELI_DESIGN, HELI_DISPONIBILIDADE) values (8, 'Heli Suporte 02', 1)
...
/* Material demo*/
insert into DEPOSITOS (COD_DEPO, COD_TIPO, LATITUDE, LONGITUDE, VOLUME) values (12, 3, 41.700473842188451 , -8.1739997863769531, 5000)
insert into DEPOSITOS (COD_DEPO, COD_TIPO, LATITUDE, LONGITUDE, VOLUME) values (13, 1, 41.728920841832704 , -8.1651967763900757, 1000)
insert into DEPOSITOS (COD_DEPO, COD_TIPO, LATITUDE, LONGITUDE, VOLUME) values (14, 1, 41.703814133775417 , -8.1234937906265259, 1230)

/*==============================================================*/
/* Test data for the table "Fogo".                     */
/*==============================================================*/
/*OS RAIO_SEGURANCA SÃO DISTÂNCIAS AO RAIO FOGO, COMO TINHA SIDO FALADO */
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (10, 6, 15, null, 1, 41.716108436365239, -8.1559575341796879, 0.8, 1.3, '2009-05-26T15:51:10', '2009-05-29T05:41:43','2009-05-29T12:32:23', 0, 2)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (1, 6, 15, null, 3, 41.933444, -8.347549, 500, 600, '2009-05-24T14:25:10', '2009-05-26T18:43:43','2009-05-25T11:43:23', 2, 0)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (2, 6, 15, null, 3, 41.899977, -8.31665, 534, 634, '2009-04-21T12:25:10', '2009-04-22T11:43:43','2009-04-22T19:55:23', 1, 10)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (3, 6, 3, null, 3, 41.537109, -8.386688, 54, 74, '2009-05-24T11:25:10', '2009-05-24T14:03:43','2009-05-25T18:33:23', 0, 7)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (4, 6, 8, null, 3, 41.436582, -8.272104, 103, 133, '2009-05-26T22:25:10', '2009-05-27T22:43:43','2009-05-28T09:13:23', 0, 4)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (5, 6, 19, null, 3, 41.904193, -8.570538, 78, 98, '2009-04-24T14:25:10', '2009-05-25T03:33:43','2009-05-25T11:21:23', 1, 3)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (6, 6, 11, null, 3, 41.701627, -8.080444, 200, 275, '2009-05-12T23:35:10', '2009-05-14T11:43:43','2009-05-16T11:03:23', 3, 2)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (7, 6, 3, null, 3, 41.55243, -8.377161, 150, 200, '2009-05-07T10:45:10', '2009-05-08T11:21:43','2009-05-09T04:05:23', 5, 1)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (8, 6, 6, null, 3, 41.545846, -8.750782, 76, 96 , '2009-05-28T09:12:10', '2009-05-28T21:51:43','2009-05-29T06:34:23', 2, 10)
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (9, 6, 23, null, 3, 41.731995, -8.807602, 89, 119, '2009-05-29T07:51:10', '2009-05-29T12:32:43','2009-05-29T17:21:23', 1, 0)
/* Fogo alterado para ser usado na demo. 
insert into FOGO (COD_FOGO, COD_COMANDANTE, COD_CONCELHO, COD_RELATORIO, COD_ESTADO, LATITUDE_FOGO, LONGITUDE_FOGO, RAIO_FOGO, RAIO_SEGURANCA, DH_START, DH_CIRCUNSCRITO, DH_FIM, BAIXAS_BOMBEIROS, BAIXAS_CIVIS) values (10, 6, 15, null, 3, 41.86694, -8.445997, 55, 75, '2009-05-26T15:51:10', '2009-05-29T05:41:43','2009-05-29T12:32:23', 0, 2)
*/
/*==============================================================*/
...
UPDATE FOGO
    ...
    FROM FOGO
    WHERE COD_FOGO = 9
/*NÂO SE INSERE. Fogo vai ser usado na demo
...
/* Não inserido por causa da simulação

...
namespace FogUM.bd
{
    ...
    partial void OnNOMEChanged();
		...
		[Association(Name="COMANDANTE_FOGO", Storage="_FOGOs", ThisKey="COD_COMANDANTE", OtherKey="COD_COMANDANTE")]
    ...
    partial void OnDISPONIBILIDADEChanged();
		...
		[Association(Name="DISTRITO_VOLUNTARIADO", Storage="_DISTRITO", ThisKey="COD_DISTRITO", OtherKey="COD_DISTRITO", IsForeignKey=true)]
    ...
    partial void OnCONCELHO_DESIGNChanged();
		...
		[Association(Name="CONCELHO_FOGO", Storage="_FOGOs", ThisKey="COD_CONCELHO", OtherKey="COD_CONCELHO")]
		public EntitySet<FOGO> FOGOs
		{
			get
			{
    ...
    partial void OnNUM_VEICULOSChanged();
		...
		[Association(Name="CORPORACAO_CORPFOGO", Storage="_CORPORACAO", ThisKey="COD_CORPORACAO", OtherKey="COD_CORPORACAO", IsForeignKey=true)]
		...
		[Association(Name="FOGO_CORPFOGO", Storage="_FOGO", ThisKey="COD_FOGO", OtherKey="COD_FOGO", IsForeignKey=true)]
		public FOGO FOGO
		{
			get
			{
    ...
    partial void OnNUM_VEICULOS_DISPChanged();
		...
		[Association(Name="CORPORACAO_CORPFOGO", Storage="_CORPFOGOs", ThisKey="COD_CORPORACAO", OtherKey="COD_CORPORACAO")]
    ...
    partial void OnVOLUMEChanged();
		...
		[Association(Name="TIPOS_DEPO_DEPOSITO", Storage="_TIPOS_DEPO", ThisKey="COD_TIPO", OtherKey="COD_TIPO", IsForeignKey=true)]
    ...
    partial void OnDISTRITO_DESIGNChanged();
		...
		[Column(Storage="_COD_DISTRITO", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int COD_DISTRITO
		{
			get
			{
		...
		[Association(Name="DISTRITO_VOLUNTARIADO", Storage="_VOLUNTARIADOs", ThisKey="COD_DISTRITO", OtherKey="COD_DISTRITO")]
    ...
    partial void OnESTADO_DESIGNChanged();
		...
		[Association(Name="ESTADO_FOGO_FOGO", Storage="_FOGOs", ThisKey="COD_ESTADO", OtherKey="COD_ESTADO")]
		public EntitySet<FOGO> FOGOs
		{
			get
			{
    ...
    partial void OnBAIXAS_CIVISChanged();
		...
		[Association(Name="FOGO_CORPFOGO", Storage="_CORPFOGOs", ThisKey="COD_FOGO", OtherKey="COD_FOGO")]
		public EntitySet<CORPFOGO> CORPFOGOs
		{
			get
			{
		...
		[Association(Name="FOGO_HELIFOGO", Storage="_HELIFOGOs", ThisKey="COD_FOGO", OtherKey="COD_FOGO")]
		...
		[Association(Name="FOGO_RELATORIO", Storage="_RELATORIOs", ThisKey="COD_FOGO", OtherKey="COD_FOGO")]
		...
		[Association(Name="COMANDANTE_FOGO", Storage="_COMANDANTE", ThisKey="COD_COMANDANTE", OtherKey="COD_COMANDANTE", IsForeignKey=true)]
		...
		[Association(Name="CONCELHO_FOGO", Storage="_CONCELHO", ThisKey="COD_CONCELHO", OtherKey="COD_CONCELHO", IsForeignKey=true)]
		...
		[Association(Name="ESTADO_FOGO_FOGO", Storage="_ESTADO_FOGO", ThisKey="COD_ESTADO", OtherKey="COD_ESTADO", IsForeignKey=true)]
		...
		[Association(Name="RELATORIO_FOGO", Storage="_RELATORIO", ThisKey="COD_RELATORIO", OtherKey="COD_RELATORIO", IsForeignKey=true)]
    ...
    partial void OnHELI_DISPONIBILIDADEChanged();
		...
		[Association(Name="HELI_HELIFOGO", Storage="_HELIFOGOs", ThisKey="COD_HELI", OtherKey="COD_HELI")]
		public EntitySet<HELIFOGO> HELIFOGOs
		{
			get
			{
    ...
    partial void OnCOD_HELIChanged();
		...
		[Association(Name="HELI_HELIFOGO", Storage="_HELI", ThisKey="COD_HELI", OtherKey="COD_HELI", IsForeignKey=true)]
		public HELI HELI
		{
			get
			{
		...
		[Association(Name="FOGO_HELIFOGO", Storage="_FOGO", ThisKey="COD_FOGO", OtherKey="COD_FOGO", IsForeignKey=true)]
		public FOGO FOGO
		{
			get
			{
    ...
    partial void OnCOMENTARIOChanged();
		...
		[Association(Name="RELATORIO_FOGO", Storage="_FOGOs", ThisKey="COD_RELATORIO", OtherKey="COD_RELATORIO")]
		public EntitySet<FOGO> FOGOs
		{
			get
			{
		...
		[Association(Name="FOGO_RELATORIO", Storage="_FOGO", ThisKey="COD_FOGO", OtherKey="COD_FOGO", IsForeignKey=true)]
		public FOGO FOGO
		{
			get
			{
    ...
    partial void OnTIPO_DESIGNChanged();
		...
		[Association(Name="TIPOS_DEPO_DEPOSITO", Storage="_DEPOSITOs", ThisKey="COD_TIPO", OtherKey="COD_TIPO")]
